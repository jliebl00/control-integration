...
public class InvestmentFundTest {
    ...
    public void setUp() throws InvalidBuyableException {
            //MAL->public InvestmentFund(Handler id, int amount, double totalPrice, Employee opener, FeeStrategy fee, double profitability)
        //(este es el nuevo!!)--> corregid el new
        //Handler id, int amount, double totalPrice, Employee opener, FeeStrategy fee, FeeStrategy cancellationFee, double profitability
...
//        invesFundTest3 = new InvestmentFund(null, 10, 200.27, null, null, 0.03);
        Assert.fail("Need to fix the test");
    }

...
public class ScheduledPayment
{
	 ...
	 */
	public ScheduledPayment(Date expiration, double importOfterm, double amortization, double interests, double pendingCapital)
	{
	...
	/**
	 * Envia la fecha de finalización del plazo de pago
	 * 
	 * @param expiration
	 *            Date con la fecha de finalización del pago.
	 */
	 ...
	 * @param amountOfTerm Double con el valor de la cuota
	 */
	public void setImportOfTerm(
			double amountOfTerm)
	{
	 ...
	 * @param amortization Double con la cantidad de dinero amortizado en ese pago
	 */
	 ...
	 * @param interests Double con el valor de la cantidad de dinero que son intereses
	 */
	 ...
	 * @param outstandingCapital Double con la cantidad de dinero que aun esta pendiente de ser amortizado
	 */
	public void setOutstandingCapital(
	...
	public String toString()
	{
		...
		a.append("Expiration date: " + form.format(expiration) + " Import of term: " + amountOfTerm + " Capital Amortization: " + amortization + " Interests: " + interests + " Pending capital: " + outstandingCapital);

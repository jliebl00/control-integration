...
public class HandlerFunds implements Handler {
	...
	public HandlerFunds(String fundName, String fundManager, String fundType, int fundShare, String stockMarket) throws MalformedHandlerException {
...
//		 Matcher matcherTicker = patternTicker.matcher(ticker);
	...
	public String toString() {
		return this.fundName + " by " + this.fundManager + " " + this.fundType + " is floated on" + this.stockMarket + " with " + this.fundShare + " shares.\n";
	}
